...
public class PasswordHashAndCheck {
    ...
    private boolean privateValidatePassword(String originalPassword, String storedPassword) throws NoSuchAlgorithmException, InvalidKeySpecException {
        ...
        System.out.println("Pass1: " + toHex(hash));
        System.out.println("Pass2: " + toHex(testHash));
    ...
    public static void main(String[] args) throws NoSuchAlgorithmException, InvalidKeySpecException {
        PasswordHashAndCheck test = new PasswordHashAndCheck();
        String originalPassword = test.scanner.next();
        String generatedSecuredPasswordHash = test.stringToSaltedHash(originalPassword);
        System.out.println(generatedSecuredPasswordHash);

        boolean matched = test.validatePassword(test.scanner.next(), generatedSecuredPasswordHash);
        System.out.println(matched);

        matched = test.validatePassword("password1", generatedSecuredPasswordHash);
        System.out.println(matched);
    }
*/
}
